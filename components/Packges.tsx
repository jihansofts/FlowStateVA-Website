    ...
    <section
      ...
      <div className="relative rounded-3xl p-6 md:px-12  ">
        ...
        <div className="grid grid-cols-1 justify-end items-end md:grid-cols-3 pt-10 gap-6">
          {/* Basic Package */}
          <div className="bg-white border border-[#093A3E52] h-[500px] px-12  rounded-2xl p-6  flex flex-col justify-between">
            <div>
          ...
          {/* Premium Package */}
          <div className="bg-[#0a1e3d] relative h-[600px]  px-12 text-white rounded-xl p-6 flex flex-col justify-between">
          ...
          {/* Enterprise Package */}
          <div className="bg-white border border-[#093A3E52] h-[500px] px-12 rounded-2xl p-6 shadow-md flex flex-col justify-between">
            <div>
              <h3 className="text-[24px] font-bold text-center text-[#1E1E1E] mb-2">
                Basic
              </h3>
